...
void *readerThread(void *conn)
{
	...
	while(networkActive)
	{
		...
		int len = sslRead(conn, buffer, sizeof(buffer));//might be?
...
void *writerThread(void *conn)
{
	...
	{
		char ch;
		printf("Command (w=forward, s=reverse, a=turn left, d=turn right, b=stop, c=clear stats, g=get stats q=exit)\n");
		scanf("%c", &ch);
...
//#define serverName         "192.168.201.195"
#define SERVER_NAME         "192.168.201.195"
#define PORT_NUM             5001
#define CA_CERT_FNAME       "signing.pem"
#define CLIENT_CERT_FNAME   "laptop.crt"
#define CLIENT_KEY_FNAME    "laptop.key"
#define SERVER_NAME_ON_CERT "raspberry"
